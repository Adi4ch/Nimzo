...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Widget build(BuildContext context) => FutureBuilder<NimzoUser?>(
        ...
        builder: (context, snapshot) {
          ...
          return ListView(padding: const EdgeInsets.all(20), children: [
            ...
            MenuTile('My Wallet', Icons.account_balance_wallet, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const WalletScreen()))),
            MenuTile('Settings', Icons.settings, onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => const SettingsScreen()))),
            MenuTile('Help & Support', Icons.help_outline, onTap: () => _showSupport(context)),
  ...
  void _showSupport(BuildContext context) => showDialog<void>(context: context, builder: (_) => AlertDialog(
