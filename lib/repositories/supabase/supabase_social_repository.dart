...
class SupabaseSocialRepository implements SocialRepository {
  ...
  Stream<SocialPost> watchPosts() {
    _channel ??= _client
        ...
        .onPostgresChanges(
            ...
            table: 'social_posts',
            callback: (payload) =>
                _posts.add(SocialPost.fromMap(payload.newRecord)))
        .subscribe();
  ...
  Future<void> sharePost(String postId) async {
    await _client.rpc('share_social_post', params: {'target_post': postId});
  }

  @override
  Future<void> blockUser(String userId) async {
    await _client.rpc('block_user', params: {'target_user': userId});
  }

  @override
  Future<void> unblockUser(String userId) async {
    await _client.rpc('unblock_user', params: {'target_user': userId});
  }
