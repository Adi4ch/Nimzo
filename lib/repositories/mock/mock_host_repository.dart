...
class MockHostRepository implements HostRepository {
  ...
  Future<HostProfile?> getHostProfile(String userId) async =>
      userId == DemoData.hostProfile.userId ? DemoData.hostProfile : null;

  @override
  Future<Map<String, dynamic>?> getAgency(String userId) async => {
        'id': 'agency-1',
        'name': DemoData.hostProfile.agencyName,
        'owner_id': userId,
        'status': 'active'
      };
  ...
  Future<Map<String, dynamic>> createAgency(
      ...
      {'id': 'agency-new', 'name': name, 'description': description};
  ...
  Future<Map<String, dynamic>> getStatistics(String userId) async =>
      {'gifts_received': 0, 'rooms_hosted': 0};
  ...
  @override
  Future<List<Map<String, dynamic>>> getAgencies() async => const [
        {
          'id': 'agency-1',
          'name': 'Nimzo Agency',
          'description': 'Community hosts',
          'status': 'active'
        }
      ];
